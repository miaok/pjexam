...
export type Question = {
  ...
  type: QuestionType;
  options: string[];
  answer: string | string[]; // string for 'single'/'boolean', string[] for 'multiple'
};
...
export const localQuestions: Question[] = [
  ...
  {
      question: "白酒标准中固形物应小于____，一般不会呈咸味，但若超过1.0g/L，而其中钠盐又占多数就可能呈咸味。",
...
{
  question: "五粮液作为浓香型白酒的典型代表，除了固态续糟、泥窖发酵、混蒸混烧、缓慢发酵这些中国白酒的固态发酵共性生产工艺外，五粮液还有自己独特的秘诀1366工艺，分别是__。",
